...
<template>
  ...
  <ExecuteActionPackage v-else :pkg="pkg" :after-execute="afterExecute">
    <template #extra>
      <Active :label="getI18nValue('RP.BURN.burnAct.generateReturn', 'Generate Return JSON')">
        <RadioItem v-model="generateReturnJson">{{
          getI18nValue('RP.BURN.burnAct.generateReturn', 'Generate Return JSON')
        }}</RadioItem>
      </Active>
      <Active :label="getI18nValue('RP.BURN.burnAct.agent', 'Agent')">
        <RadioItem v-model="agent">{{ getI18nValue('RP.BURN.burnAct.agent', 'Agent') }}</RadioItem>
      </Active>
    </template>
