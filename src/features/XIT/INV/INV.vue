...
<template>
  ...
  <template v-else>
    <div :class="C.ComExOrdersPanel.filter">
      ...
      <RadioItem v-model="showBaseWar" horizontal>{{
        getI18nValue('RP.INV.baseWar', 'BASE WAR')
      }}</RadioItem>
      ...
      <div :class="$style.searchContainer">
        <input
          ...
          data-1p-ignore="true"
          data-lpignore="true"
          :placeholder="getI18nValue('RP.INV.locationPlaceholder', 'Enter location')"
    ...
    <table :class="$style.table">
      <thead>
        <tr>
          <th :class="$style.nameCol">{{ getI18nValue('RP.INV.name', 'Name') }}</th>
          <th :class="$style.typeCol">{{ getI18nValue('RP.INV.type', 'Type') }}</th>
          <th :class="$style.barCol">{{ getI18nValue('RP.INV.inventory', 'Inventory') }}</th>
        </tr>
      </thead>
      <tbody>
